...
use ZfTwitterBootstrap\Form\Element\MultiCheckbox as MultiCheckboxElement;
...
class FormMultiCheckbox extends FormInput
{
                                     ...
                                     array $attributes)
    {
        ...
        foreach ($options as $key => $optionSpec) {
            ...
            $labelAttributes = is_array($globalLabelAttributes) ? $globalLabelAttributes : array($globalLabelAttributes);
            ...
            } else if ($this->getInputType() == 'radio') {
